...
const plans = [
  {
    ...
    features: ["50 AI credits", "Generate quizzes", "Create flashcards", "AI summaries", "Mobile access"],
    popular: false,
    cta: "Buy Starter",
  },
  {
    ...
    features: ["100 AI credits", "Generate quizzes", "Create flashcards", "Advanced AI summaries", "Spaced repetition", "Priority support"],
    popular: true,
    cta: "Buy Standard",
  },
  {
    ...
    features: ["350 AI credits", "Everything in Standard", "Bulk quiz generation", "Study analytics", "Fastest AI responses", "Priority support"],
    popular: false,
    cta: "Buy Pro",
  },
];
