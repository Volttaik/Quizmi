    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <div className="relative max-w-lg mx-auto px-4 pt-8">
        ...
        <div className="bg-card rounded-2xl p-4 mb-4 flex items-center justify-between shadow-sm border border-border/40">
          ...
          <Link href="/buy-credits" className="bg-primary/10 text-primary text-xs font-bold px-4 py-2 rounded-full hover:bg-primary/20 transition-colors">
            Add Credits
          </Link>
        </div>
...
function SettingRow({ icon: Icon, label, to }: { icon: React.ElementType; label: string; to: string }) {
  return (
    <Link href={to} className="flex items-center gap-3 px-4 py-3.5 hover:bg-muted/50 transition-colors border-b border-border/30 last:border-0">
